...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'manikandan1905213@gmail.com' ")
...
background_image = Image.open("C:\\Users\\Dell\\Downloads\\Screenshot 2024-03-06 132453.png")  # Replace "background_image.jpg" with the path to your image

# Resize the image
width = 1600
height = 900

background_image = background_image.resize((width, height))  # Adjust the size as needed
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ",width=55 ,height=1,font=('comic', 22, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,width=55 ,height=1,font=('comic', 22, ' bold '))
